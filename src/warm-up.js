...
function statePaceOfReading(pages) {
    if (pages < 1000) {
...
var books = ["Cell Biology", "Human Physiology", "Sociology", "StrengthsFinder", "The Mindfulness Coloring Book"]
...
var belowTwoHundred = [1, 2, 3, 4, 5, 6, 70, 80, 9, 10, 110, 120];
